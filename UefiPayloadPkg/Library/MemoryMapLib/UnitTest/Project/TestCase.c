...
TEST_CASE  gTestCase[] = {
  { RETURN_UNSUPPORTED, TestCase1, 506, "MemoryMapLib.c" },
  { RETURN_UNSUPPORTED, TestCase2, 415, "MemoryMapLib.c" },
  { RETURN_UNSUPPORTED, TestCase3, 664, "Hob.c"          },     // in hob.c
  { RETURN_UNSUPPORTED, TestCase4, 362, "MemoryMapLib.c" },
  { RETURN_UNSUPPORTED, TestCase5, 367, "MemoryMapLib.c" },
  { RETURN_SUCCESS,     TestCase6, 0,   "MemoryMapLib.c" },
  { RETURN_UNSUPPORTED, TestCase7, 373, "MemoryMapLib.c" },
  { RETURN_UNSUPPORTED, TestCase8, 410, "MemoryMapLib.c" },
};
